...
ActiveRecord::Schema.define(version: 20160420130410) do
  ...
  create_table "labeldata", force: :cascade do |t|
    t.integer  "order_id",             limit: 4
    t.integer  "optionvalue_label_id", limit: 4
  ...
  create_table "optionvalue_labels", force: :cascade do |t|
  ...
  create_table "productinserts", force: :cascade do |t|
    t.integer  "product_id",  limit: 4
    t.integer  "insert_id",   limit: 4
  ...
  create_table "variant_option_values_labels", force: :cascade do |t|
    t.integer  "label_id",                limit: 4
    t.integer  "option_value_variant_id", limit: 4
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
  end
